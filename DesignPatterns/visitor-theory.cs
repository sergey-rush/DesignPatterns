...
namespace ObjectStructureVisitorPattern
{
    ...
    class Client
    {
        static void MainRun()
        {
            ...
            Element objectStructure =new Element(new Element(new ElementWithLink(new Element(new Element(new ElementWithLink(new Element(null),new Element(null)))),new Element(new Element(new Element(null))))));
